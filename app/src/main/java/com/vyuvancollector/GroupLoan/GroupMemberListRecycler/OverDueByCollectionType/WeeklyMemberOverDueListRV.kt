package com.vyuvancollector.GroupLoan.GroupMemberListRecycler.OverDueByCollectionType
...
import com.vyuvancollector.databinding.ActivityWeeklyMemberOverDueListRvBinding
import com.google.gson.JsonObject
import com.vyuvancollector.GroupLoan.GroupMemberList.AllMemberList
import com.vyuvancollector.GroupLoan.GroupMemberList.WeeklyMemberList
...
class WeeklyMemberOverDueListRV(private val list :List<WeeklyMemberOverDueData>) : RecyclerView.Adapter<WeeklyMemberOverDueListRV.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityWeeklyMemberOverDueListRvBinding.inflate(LayoutInflater.from(parent.context),parent,false)

        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: WeeklyMemberOverDueListRV.MyViewHolder, position: Int) {
    ...
    inner class MyViewHolder(var binding: ActivityWeeklyMemberOverDueListRvBinding) : RecyclerView.ViewHolder(
        binding.root
    ){}
}