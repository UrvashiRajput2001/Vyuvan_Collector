...
import com.vyuvancollectors.databinding.ActivityDailyBinding
...
class Daily : AppCompatActivity() {
    ...
    private var binding : ActivityDailyBinding? = null

    private var recyclerView : DailyEMIRecyclerView? = null
...
//            binding?.messageTxt?.isVisible = true
        ...
        if (typo == "3"){
            ...
            json.addProperty("collectionType","$daily")
                ...
                override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                    if (response.isSuccessful) {
                        ...
                        if (status == true) {
                            ...
                            binding?.dailyEmiRv?.adapter = recyclerView
        ...
        when (typo) {
            ...
            "1" -> {
                ...
                call?.enqueue(object : Callback<JsonObject> {
                    ...
                    override fun onFailure(call: Call<JsonObject>, t: Throwable) {
//                        Toast.makeText(this@Daily, t.toString(), Toast.LENGTH_LONG).show()
                        Log.e("urvashi", "$t your response is fail")
                    }
                })
            }
                    ...
                    override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                        if (response.isSuccessful) {
                            ...
                            if(jsonArray.isNull(0)){
                                binding?.messageTxt?.isVisible = true
                                binding?.messageTxt?.text = "No EMI's"
                                binding?.dailyEmiRv?.isVisible = false
                                binding?.sorryImg?.isVisible = true
                            }
