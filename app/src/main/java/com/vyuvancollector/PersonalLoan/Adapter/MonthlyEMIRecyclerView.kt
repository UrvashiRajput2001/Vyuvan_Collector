...
import com.vyuvancollector.PersonalLoan.CustomerLoanDetails.LoanDetailsMonthly
import com.vyuvancollector.PersonalLoan.Data_Class.ModalMonthly
...
import com.vyuvancollector.databinding.ActivityMonthlyEmirecyclerViewBinding
...
class MonthlyEMIRecyclerView(private val list :List<ModalMonthly>) : RecyclerView.Adapter<MonthlyEMIRecyclerView.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityMonthlyEmirecyclerViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: MonthlyEMIRecyclerView.MyViewHolder, position: Int) {
        ...
        holder.binding.ll1.setOnClickListener{
            val intent = Intent(context, LoanDetailsMonthly::class.java)
    ...
    inner class MyViewHolder(var binding: ActivityMonthlyEmirecyclerViewBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}