...
import com.vyuvancollector.databinding.ActivityGlphoneSearchBinding
...
//            binding?.messageTxt?.isVisible = true
    ...
    private fun forPhoneSearch(){
        if(binding?.searchEt?.text?.length == 10) {
            ...
            val call = apiClient?.postData2(token, "/v1/emi/groupEmis/getAllGroupDetailByMobile", jsonObject)
