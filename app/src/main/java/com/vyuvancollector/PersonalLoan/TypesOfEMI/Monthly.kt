...
import com.vyuvancollector.PersonalLoan.Adapter.MonthlyEMIRecyclerView
...
import com.vyuvancollector.databinding.ActivityMonthlyBinding
...
//            binding?.messageTxt?.isVisible = true
        ...
        if(typo == "3"){
            ...
            listener2 = DatePickerDialog.OnDateSetListener { view: DatePicker, Year: Int, month: Int, date: Int ->
                ...
                Log.e("urvashi", "date $initDate $endDate")
