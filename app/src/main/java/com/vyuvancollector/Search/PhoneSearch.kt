...
import com.vyuvancollector.databinding.ActivityPhoneSearchBinding
...
//            binding?.messageTxt?.isVisible = true
    ...
    private fun forSearch(){
        ...
        val call = apiClient?.postDataGET2(token.toString(),"v1/loans/getCustomerLoanDetails/$agentId/$phone")
