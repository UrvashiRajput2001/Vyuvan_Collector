package com.vyuvancollector.PersonalLoan.Adapter
...
import com.vyuvancollector.PersonalLoan.CustomerLoanDetails.LoanDetailsWeekly
import com.vyuvancollector.PersonalLoan.Data_Class.ModalWeekly
...
import com.vyuvancollector.databinding.ActivityWeeklyEmirecyclerViewBinding
import com.google.gson.JsonObject
import com.vyuvancollector.PersonalLoan.TypesOfEMI.Daily
import com.vyuvancollector.PersonalLoan.TypesOfEMI.Monthly
import com.vyuvancollector.PersonalLoan.TypesOfEMI.Weekly
...
class WeeklyEMIRecyclerView(private val list :List<ModalWeekly>) : RecyclerView.Adapter<WeeklyEMIRecyclerView.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityWeeklyEmirecyclerViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    @SuppressLint("SimpleDateFormat", "SdCardPath", "SetTextI18n")
     override fun onBindViewHolder(holder: WeeklyEMIRecyclerView.MyViewHolder, position: Int) {
        ...
        holder.binding.ll1.setOnClickListener{
            val intent = Intent(context, LoanDetailsWeekly::class.java)
        ...
        holder.binding.collectEmiBtn.setOnClickListener {
            ...
            bind.cashMsgOkBtn.setOnClickListener {
                ...
                val call = apiClient?.postData2(token,"v1/emi/emiollect",jsonObject)
                call?.enqueue(object  : Callback<JsonObject> {
                    override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                        ...
                        val intent = Intent(context1, Weekly::class.java)
                        intent.putExtra("token","$token")
                        intent.putExtra("agentId","$agentId")
    ...
    inner class MyViewHolder(var binding: ActivityWeeklyEmirecyclerViewBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}