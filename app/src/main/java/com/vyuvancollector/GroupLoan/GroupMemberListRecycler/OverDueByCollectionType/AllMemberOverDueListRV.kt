...
import com.vyuvancollector.databinding.ActivityAllMemberOverDueListRvBinding
...
class AllMemberOverDueListRV(private val list :List<AllMemberOverDueData>) : RecyclerView.Adapter<AllMemberOverDueListRV.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityAllMemberOverDueListRvBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: AllMemberOverDueListRV.MyViewHolder, position: Int) {
        ...
        Log.e("urvashi","$emiAmount emiAmount")
    ...
    inner class MyViewHolder(var binding: ActivityAllMemberOverDueListRvBinding) : RecyclerView.ViewHolder(
        binding.root
    ){}
}