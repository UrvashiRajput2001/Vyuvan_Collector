...
import com.vyuvancollector.databinding.ActivityAllMemberPendingListRvBinding
...
class AllMemberPendingListRV(private val list :List<AllMemberPendingData>) : RecyclerView.Adapter<AllMemberPendingListRV.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityAllMemberPendingListRvBinding.inflate(LayoutInflater.from(parent.context),parent,false)

        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AllMemberPendingListRV.MyViewHolder, position: Int) {
    ...
    inner class MyViewHolder(var binding: ActivityAllMemberPendingListRvBinding) : RecyclerView.ViewHolder(
        binding.root
    ){}
}