package com.vyuvancollector.GroupLoan.GroupMemberListRecycler.PendingByCollectionType
...
import com.vyuvancollector.databinding.ActivityMonthlyMemberPendingListRvBinding
import com.google.gson.JsonObject
import com.vyuvancollector.GroupLoan.GroupMemberList.AllMemberList
import com.vyuvancollector.GroupLoan.GroupMemberList.MonthlyMemberList
...
class MonthlyMemberPendingListRv(private val list :List<MonthlyMemberPendingData>) : RecyclerView.Adapter<MonthlyMemberPendingListRv.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityMonthlyMemberPendingListRvBinding.inflate(LayoutInflater.from(parent.context),parent,false)

        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: MonthlyMemberPendingListRv.MyViewHolder, position: Int) {
    ...
    inner class MyViewHolder(var binding: ActivityMonthlyMemberPendingListRvBinding) : RecyclerView.ViewHolder(
        binding.root
    ){}
}