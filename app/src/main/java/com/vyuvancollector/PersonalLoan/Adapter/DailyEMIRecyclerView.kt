...
import com.vyuvancollector.PersonalLoan.CustomerLoanDetails.LoanDetailsDaily
...
import com.vyuvancollector.databinding.ActivityDailyEmirecyclerViewBinding
...
class DailyEMIRecyclerView(private val list :List<ModalDaily>) : RecyclerView.Adapter<DailyEMIRecyclerView.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val binding = ActivityDailyEmirecyclerViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: DailyEMIRecyclerView.MyViewHolder, position: Int) {
        ...
        holder.binding.ll1.setOnClickListener{
            val intent = Intent(context, LoanDetailsDaily::class.java)
            ...
            bind.cashMsgOkBtn.setOnClickListener {
                ...
                call?.enqueue(object  : Callback<JsonObject> {
                    override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                        ...
                        val intent = Intent(context1, Daily::class.java)
                        intent.putExtra("token","$token")
                        intent.putExtra("agentId","$agentId")
    ...
    inner class MyViewHolder(var binding: ActivityDailyEmirecyclerViewBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}